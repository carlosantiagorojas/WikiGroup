...
/**
 * This controller is used to serve the requirements page.
 * 
 ...
 * all requests that come in at the /requirements path.
 */
@Controller
...
public class RequirementsController {
     ...
     * requests that come in at the /requirements path.
     */
    @RequestMapping()
